...
#lcd_print_digit
	...
	'IF lcd_temp > 99 THEN lcd_param = (lcd_temp / 100) + &h30          ELSE lcd_param = &h40
	lcd_param = (lcd_temp / 100) + &h30
	GOSUB lcd_put
#lcd_print_digit_2
	'IF lcd_temp > 9  THEN lcd_param = ((lcd_temp MOD 100) / 10) + &h30 ELSE lcd_param = SPACE
	'IF lcd_temp > 9  THEN lcd_param = ((lcd_temp MOD 100) / 10) + &h30 ELSE lcd_param = &h40
	lcd_param = ((lcd_temp MOD 100) / 10) + &h30
	GOSUB lcd_put
#lcd_print_digit_1
